# Generated by Django 3.1.1 on 2020-12-11 14:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response', models.ManyToManyField(related_name='response', to='g_forms.Answer')),
                ('response_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='response_to', to='g_forms.form')),
            ],
        ),
        migrations.CreateModel(
            name='Questions',
            fields=[
                ...
                ('choices', models.ManyToManyField(related_name='choices', to='g_forms.Choices')),
            ],
        ),
        migrations.AddField(
            model_name='form',
            name='questions',
            field=models.ManyToManyField(related_name='questions', to='g_forms.Questions'),
        ),
        migrations.AddField(
            model_name='answer',
            name='answer_to',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answer_to', to='g_forms.questions'),
        ),
    ]
